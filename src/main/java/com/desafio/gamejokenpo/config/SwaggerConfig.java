package com.desafio.gamejokenpo.config;
	    ...
	    public Docket api() {
	        return new Docket(DocumentationType.SWAGGER_2)
	            ...
	            .apis(RequestHandlerSelectors
						.basePackage("com.desafio.gamejokenpo"))
	            .paths(PathSelectors.regex("/.*"))
	            .build().apiInfo(apiEndPointsInfo());
	    }
	    private ApiInfo apiEndPointsInfo() {
	        return new ApiInfoBuilder().title("REST API Game Jokenpo")
	            .description("API para game Jokenpo")
	            .contact(new Contact("Rodrigo Nascimento", "https://www.teste.com.br", "rodrigo_allexandre@yahoo.com.br"))
	            .license("Apache 2.0")
